...
import static com.vinnilmg.jms.messaging.MessagingUtils.createSessionWithClientAck;

public class QueueConsumerWithManualAckTest {
    ...
    public static void initConsumer() throws NamingException, JMSException {
        ...
        try (final var connection = createConnection(context)) {
            ...
            try (
                    final var session = createSessionWithClientAck(connection);
                ...
                consumer.setMessageListener(message -> {
                    ...
                    try {
                        ...
                        message.acknowledge();
                        System.out.println("Ack realizado.");
